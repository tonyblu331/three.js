export function appendLightProbeProofProbeDiagnosticsMarkdown( lines, report ) {
	...
	lines.push(
		...
		`- Final visible material gate: ${ sealedRenderMetricMismatch.finalVisibleMaterialGate }`,
		`- Final visible masked ratios: standard ${ sealedRenderMetricMismatch.finalVisibleStandardMaskedWrongSideColorRatio }, raw-debug ${ sealedRenderMetricMismatch.finalVisibleDebugMaskedWrongSideColorRatio }, no-tone ${ sealedRenderMetricMismatch.finalVisibleNoToneMappingMaskedWrongSideColorRatio }, linear-output ${ sealedRenderMetricMismatch.finalVisibleLinearOutputMaskedWrongSideColorRatio }, lambert-debug ${ sealedRenderMetricMismatch.finalVisibleLambertDebugMaskedWrongSideColorRatio }`,
		`- Final visible deltas: standard-vs-debug masked ${ sealedRenderMetricMismatch.finalVisibleStandardVsDebugMaskedDelta }, tone-mapping masked ${ sealedRenderMetricMismatch.finalVisibleToneMappingMaskedDelta }, output-color masked ${ sealedRenderMetricMismatch.finalVisibleOutputColorSpaceMaskedDelta }, exposure masked ${ sealedRenderMetricMismatch.finalVisibleExposureMaskedDelta }, lambert-vs-standard-linear masked ${ sealedRenderMetricMismatch.finalVisibleLambertVsStandardLinearMaskedDelta }, renderer ${ sealedRenderMetricMismatch.finalVisibleRenderer.currentToneMapping } / ${ sealedRenderMetricMismatch.finalVisibleRenderer.outputColorSpace }`,
		`- Offscreen scene-linear target: ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearTarget.status } mode ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearTarget.mode } masked wrong-side ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearTarget.maskedWrongSideColorRatio ?? 'n/a' } correct bounce ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearTarget.maskedCorrectBounceRatio ?? 'n/a' }`,
		`- Offscreen contribution isolation: ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearContributionSummary.status } dominant ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearContributionSummary.dominantWrongSideLabel ?? 'n/a' } wrong-side ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearContributionSummary.dominantWrongSideColorRatio ?? 'n/a' }`,
		`- Offscreen contribution deltas: direct-vs-ambient ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearContributionSummary.directAmbientMaskedDelta ?? 'n/a' }, probes-vs-direct+probes ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearContributionSummary.probesDirectPlusMaskedDelta ?? 'n/a' }`,
		`- Neutral receiver contribution gate: ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearContributionGate.status } neutral probe wrong ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearContributionGate.neutralProbesOnly?.maskedWrongSideColorRatio ?? 'n/a' } chroma pressure ${ sealedRenderMetricMismatch.finalVisibleOffscreenSceneLinearContributionGate.neutralProbesOnly?.chromaticityWrongSidePressure ?? 'n/a' }`,
