...
export function createLightProbeProofMarkdown( report ) {
	...
	lines.push(
		...
		`- Linear promotion wrong-side improvement: ${ wgpuLeakAuditStudy.linearPromotionStudy.visibilityPreToneMaskedWrongSideImprovementRatio }`,
		`- Linear promotion correct-bounce preservation: ${ wgpuLeakAuditStudy.linearPromotionStudy.visibilityPreToneMaskedCorrectBouncePreservation }`,
