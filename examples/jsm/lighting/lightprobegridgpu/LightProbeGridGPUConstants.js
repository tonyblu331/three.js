...
export const MIN_PROBE_SPACING = 0.0001;
export const PROBE_VALIDITY_FLOOR = 0.05;
export const SAFE_NORMALIZE_EPSILON = 0.0001;
...
export const VISIBILITY_OCTAHEDRAL_NORMALIZE_EPSILON = 0.0001;
export const VISIBILITY_WEIGHT_SUM_FLOOR = 0.0001;
export const VISIBILITY_MOMENT_FILTER_TAP_COUNT = 9;
export const DEFAULT_PROBE_LAYER_MASK = 1;
export const MAX_PROBE_LAYER_MASK = 0xFFFFFF;
export const RECEIVER_BOUNDARY_SELECTION_THRESHOLD = 0.5;
